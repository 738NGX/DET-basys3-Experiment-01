...
HD_PWD='F:/Develop/basys3/basys3-01/basys3-01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainDesign.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainDesign.tcl -notrace
