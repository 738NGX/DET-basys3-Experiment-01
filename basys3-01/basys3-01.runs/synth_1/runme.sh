...
HD_PWD='F:/Develop/basys3/basys3-01/basys3-01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainDesign.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainDesign.tcl
